...
import { getBusinessContext,getPatientPayments,startPaymentCheckout,purchaseSubscription } from './phase5'
const user='00000000-0000-4000-8000-000000000001'
describe('phase 5 offline-safe operations',()=>{
  it('never reports a purchase when subscriptions are unavailable',async()=>{await expect(purchaseSubscription(user,{identifier:'patient-plus',title:'Patient Plus',description:'Optional plan',price:'BDT 299'})).rejects.toThrow('SUBSCRIPTIONS_NOT_CONFIGURED')})
