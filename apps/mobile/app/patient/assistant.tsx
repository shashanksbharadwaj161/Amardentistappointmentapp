// THESIS: A calm triage notebook, not a chatbot theatre. OWN-WORLD: pearl paper, ink, mint, one high-signal urgency card. STORY: choose purpose, describe, receive bounded guidance, book. FIRST VIEWPORT: safety contract plus one input. FORM: quiet care ledger.
import { aiTaskRequestSchema, type PatientGuidance } from '@amar-dentist/domain'
...
const styles=StyleSheet.create({screen:{paddingTop:spacing.xl,gap:spacing.lg},hero:{gap:spacing.sm},heroIcon:{width:54,height:54,borderRadius:27,alignItems:'center',justifyContent:'center',backgroundColor:colors.inkDeep},kicker:{color:colors.teal,fontSize:11,fontWeight:'800',letterSpacing:1.2},title:{color:colors.inkDeep,fontSize:34,lineHeight:39,fontWeight:'800',letterSpacing:-1.1},subtitle:{color:colors.muted,fontSize:14,lineHeight:22},safety:{flexDirection:'row',gap:spacing.sm,padding:spacing.md,backgroundColor:colors.mintSoft,borderRadius:radius.md},safetyText:{flex:1,color:colors.teal,fontSize:12,lineHeight:18},tabs:{flexDirection:'row',flexWrap:'wrap',gap:spacing.sm},tab:{minHeight:44,justifyContent:'center',paddingHorizontal:14,borderRadius:radius.pill,backgroundColor:colors.paper,borderWidth:1,borderColor:colors.line},tabActive:{backgroundColor:colors.inkDeep,borderColor:colors.inkDeep},tabText:{color:colors.text,fontSize:12,fontWeight:'700'},tabTextActive:{color:colors.paper},error:{color:colors.danger,fontSize:12},result:{gap:spacing.lg},urgency:{flexDirection:'row',gap:spacing.md,padding:spacing.lg,borderRadius:radius.lg,backgroundColor:colors.mintSoft},urgencyHigh:{backgroundColor:'#FFF0F0'},urgencyLabel:{color:colors.teal,fontSize:11,fontWeight:'800',letterSpacing:1},resultSummary:{color:colors.inkDeep,fontSize:18,lineHeight:25,fontWeight:'800',marginTop:4},flex:{flex:1},bullet:{color:colors.text,fontSize:14,lineHeight:22},redFlag:{color:colors.danger,fontSize:13,lineHeight:21},disclaimer:{color:colors.muted,fontSize:11,lineHeight:17,fontStyle:'italic'},route:{flexDirection:'row',gap:spacing.sm,paddingHorizontal:spacing.sm,alignItems:'flex-start'},routeText:{flex:1,color:colors.muted,fontSize:11,lineHeight:17}})
