...
-- Preserve booking behavior while making CASE results explicitly enum typed.
...
begin
  ...
  disposition := case when appointment_record.start_at >= clock_timestamp() + interval '24 hours' then 'refundable'::public.deposit_disposition else 'forfeited'::public.deposit_disposition end;
